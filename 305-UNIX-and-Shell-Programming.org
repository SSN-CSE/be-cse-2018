...
Bash Basics: Interactive shell usage -- Input & output -- Background
jobs -- Special characters and quoting; Command-Line Editing: Enabling
command-line editing -- The history list -- emacs editing mode --
emacs editing mode -- The fc command -- Histroy expansion -- readline;
Customizing your environment; .bash\underline{ }profile,
.bash\underline{ }logout, .bashrc Files -- Aliases -- Options -- Shell
variables -- Customization and subprocesses.
