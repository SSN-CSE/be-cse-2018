...
I/O -- Command-line processing; sed and awk; Process Handling: Process IDs & job
numbers -- Job control -- Trap -- Coroutines -- Subshells
...
6. Exercises on sed
7. Exercises on awk.
8. Exercises on Shell program debugging.
