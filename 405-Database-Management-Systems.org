...
#+begin_comment
Part of first unit in AU-2017. Extended with more titles to provide better
 understanding towards relational model. 
#+end_comment
...
#+begin_comment
Second unit in AU-2017. Added database triggers,views to provide better
 knowledge towards database programming. 
#+end_comment
...
- Design databases systematically and develop database software for various real-time applications (K3)
