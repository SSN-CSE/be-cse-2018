...
:properties:
:author: Ms. S. Manisha and Mr. K. R. Sarath Chandran, ADS (last updated 01/04/2022
:date: 
:end:
...
** COURSE OBJECTIVES
1. Understand the basic architecture, operation, programming of microprocessor 8086 (K3)
2. Understand the design of basic and multiprocessor systems and their bus timings (K2)
3. Design the 8086 interfaces with memory, I/O and other peripheral chips (K3)
4. Understand the basic architecture and operation of microcontroller 8051 (K2)
