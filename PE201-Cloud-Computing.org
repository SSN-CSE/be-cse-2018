...
Parallel Programming Framework: Hadoop Map Reduce -- Google App Engine -- Amazon AWS -- Microsoft Azure; Cloud Software
Environments -- Eucalyptus -- OpenStack -- OpenNebula -- Aneka -- CloudSim.
...
2. Krutz, R. L., Vines, R. D, ``Cloud security. A Comprehensive Guide
...
6. Tim Mather, Subra Kumaraswamy, and Shahed Latif , ``Cloud Security
