...
the text book.  Threaded binary trees and B+ tree is removed as per AU
...
All-pairs shortest path -- Breadth-first traversal -- Depth-first
...
#+BEGIN_COMMENT
Few sorting techniques are removed as per AU syllabus due to time
constraint.
#+END_COMMENT
