...
2. Comments for the addition,deletion with respect to AU R-2017 have been included along with the units
...
- Analyze a problem statement and choose an appropriate data structure
  to solve it (K4).
  
 #+BEGIN_COMMENT
Elucidate and implement various operations of List (K2)
Develop applications using stack and queue (K3)
Implement the operations of balanced and unbalanced trees (K2)
Develop applications using traversal and shortest path algorithms for graphs (K3)
Choose a suitable searching and sorting algorithms to solve a computing problem (K4)
#+END_COMMENT
