...
Design: The Golden rules, Interface analysis, Interface Design –Component level Design: Designing Class based components, traditional Components.
...
path testing-control structure testing-black box testing- Unit Testing – Integration Testing –Regression Testing- Validation Testing – System Testing - Debugging – Software Implementation: Coding practices and principles - Maintenance:Reengineering- Reverse Engineering - Restructuring.
