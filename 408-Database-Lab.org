...
** COURSE OBJECTIVES
- To understand data definitions and data manipulation commands(K3)
- To learn about the use of nested and join queries(K3)
- To understand procedural extensions of databases(K3)
- To design a database schema for an application using Normalization(K3)
- To implement typical database applications using Front-end tools(K3)
