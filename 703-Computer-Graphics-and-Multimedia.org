...
#+begin_comment
- 1. Unit V changed to include MUltimedia concepts.
- 2.  Unit I - Random and Raster scan systems are added as introductory topics.
      Unit III - B SPlines is removed as under spline representaions topic, Bezier curve is already given.
