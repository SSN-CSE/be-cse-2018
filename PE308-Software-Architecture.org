...
- 2. Removed the second unit on Software Desig
...
- To learn the architectural architectural styles
...
Architecture of software systems ivoving Internet-of-Things(IoT) 
