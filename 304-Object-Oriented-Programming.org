...
- 2. The same course is not offered in P.G. Hence, there is no requirement of comparison of this syllabus with PG syllabus
- 3. Five course outcomes are specified and aligned with the units
- 4. Suggestive experiments have not been specified in this syllabus as it is not an integrated course. There is seperate lab course is available
#+end_comment
...
dispatch; Exceptions: Hierarch -- Built-in exceptions -- Creating own
