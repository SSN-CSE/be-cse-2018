...
#+begin_comment
- 1. Combined Unit 2 and 3 of AU into Unit 2, Unit 4 and 5 of AU into Unit 3 to give emphasis on NLP applications
- 2. For changes, see the indidual units
- 3. The unit headings are similar to M.E syllabus with addition and deletion of topics except Unit 4. Unit 4 and 5 are focussing on NLP applications. Removed NLP using Python
...
- 1. As Unit 4 and part of Unit 5 of AU are combined to Unit 3, the topics namely First-Order Logic and Description Logics are removed.
- 2. Unit 3 is same as Unit 3 of M.E syllabus
#+end_comment
...
- 1. AU does not focus on NLP applications. NLP applications namely MT, IR and IE are included in this unit.
...
- 1. AU focuses on lexical resources but not on applications. NLP applications namely QA and Summarization are included in this unit. Lexical resources are removed which will be indirectly covered through NLP applications.
- 2. Additionally included the applications namely QA and Summarization when compared with M.E syllabus.
#+end_comment
